        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <div class="mb-2 p-2.5 rounded-lg bg-(--primary)/10 border border-(--primary)/20 text-xs">
                <span class="font-semibold text-(--primary)">💡 推荐方式：</span>前往 <a href="https://github.com/LengxiQwQ/lengxiqwq-site/issues/new?template=04-friend_apply.yml" target="_blank" rel="noopener noreferrer" class="text-(--primary) underline font-semibold hover:opacity-80">GitHub 提交 Issue 申请</a>，系统将自动校验反链并秒级上线！
              </div>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed mb-2">或者在下方评论区留言、发邮件到 <code class="px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[0.7rem]">{site.email}</code>：</p>

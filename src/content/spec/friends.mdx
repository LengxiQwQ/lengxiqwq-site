        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">在下面评论区留言，或者发邮件到 <code class="px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[0.7rem]">{site.email}</code></p>
          ...
          <div class="flex gap-3.5">
            ...
            <div>
              <p class="font-semibold text-sm mb-1">然后就等我看到啦</p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">我看过站点和信息后，没什么问题就会加上</p>
            </div>
          </div>
        </div>
      </div>

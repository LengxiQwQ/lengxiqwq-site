    ...
    <div class="relative flex">
        <div class="relative flex-1">
            ...
            <input
                ...
                class="block w-full p-4 pl-10 text-sm bg-transparent border border-black/10 dark:border-white/10 rounded-lg focus:ring-2 focus:ring-(--primary) focus:border-(--primary) md:hover:border-black/20 dark:md:hover:border-white/20 text-75 placeholder:opacity-50 transition-colors outline-hidden"

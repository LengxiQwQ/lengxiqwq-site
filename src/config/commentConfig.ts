...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		...
		// 中国推荐1: https://registry.npmmirror.com/twikoo/1.6.44/files/dist/twikoo.all.min.js
		// 中国推荐2: https://s4.zstatic.net/npm/twikoo@1.6.44/dist/twikoo.all.min.js
		// 国际推荐: https://cdn.jsdelivr.net/npm/twikoo@1.6.44/dist/twikoo.all.min.js
